...
global whitePos2 battlePos2 numWhite2 numBattle2 Drawrifle2 Drawrider2 Drawarcher2 Drawwhite2 Drawblack2 Drawblack Drawgreen2 Drawgreen...
    ...
    buttonEnd resource2 textresource2 t_client
    ...
    case 'normal'
        ...
        if sum(judgemove)>0 &&  moveType2==1
            if rifle2.posStore2(xrifle2,3)==0 && rifle2.posStore2(xrifle2,4)==0
                ...
                % 将更新后的数据传输给玩家1
                fwrite(t_client,[-4,xrifle2,gonnaMove2(1),gonnaMove2(2)],'double');  % 写入数字数据
            end
        ...
        elseif sum(judgemove)>0 && moveType2==2
            if rider2.posStore2(xrider2,3)==0 && rider2.posStore2(xrider2,4)==0
                ...
                % 将更新后的数据传输给玩家1
                fwrite(t_client,[-5,xrider2,gonnaMove2(1),gonnaMove2(2)],'double');  % 写入数字数据
            end
            set(gcf,'WindowButtonDownFcn',@clicktown2);
        elseif sum(judgemove)>0 && moveType2==3
            if archer2.posStore2(xarcher2,3)==0 && archer2.posStore2(xarcher2,4)==0
                ...
                % 将更新后的数据传输给玩家1
                fwrite(t_client,[-6,xarcher2,gonnaMove2(1),gonnaMove2(2)],'double');  % 写入数字数据
            end
            set(gcf,'WindowButtonDownFcn',@clicktown2);
        % 攻击
        elseif sum(judgebattle)>0 && battleType2==1  % 攻击者为步兵
            ...
            if attackType==1
                ...
                % 将更新后的数据传输给玩家1
                fwrite(t_client,[-7,xrifle2,gonnaAttack2(1),gonnaAttack2(2),harmOwn2,ordg,harm2],'double');  % 步->步
                harmText2;
            ...
            elseif attackType==2
                ...
                % 将更新后的数据传输给玩家1
                fwrite(t_client,[-8,xrifle2,gonnaAttack2(1),gonnaAttack2(2),harmOwn2,ordg,harm2],'double');  % 步->骑
                harmText2;
            ...
            elseif attackType==3
                ...
                fwrite(t_client,[-9,xrifle2,gonnaAttack2(1),gonnaAttack2(2),harmOwn2,ordg,harm2],'double');  % 步->弓
                harmText2;
            ...
            elseif attackType==4
                ...
                delete(Drawfocus2);
                delete(DrawfocusTown2);
                fwrite(t_client,[-10,harm2],'double');  % 步->塔
                harmTextTown2;
        ...
        elseif sum(judgebattle)>0 && battleType2==2  % 攻击者为骑兵
            ...
            if attackType==1
                ...
                fwrite(t_client,[-11,xrider2,gonnaAttack2(1),gonnaAttack2(2),harmOwn2,ordg,harm2],'double');  % 骑->步
                harmText2;
            ...
            elseif attackType==2
                ...
                fwrite(t_client,[-12,xrider2,gonnaAttack2(1),gonnaAttack2(2),harmOwn2,ordg,harm2],'double');  % 骑->骑
                harmText2;
                bloodRider1(ordg,1)=blood-80/65*harm2;
                if bloodRider1(ordg,1)>0  % 受攻击敌兵没有死
                    set(Drawgreen.rider(ordg,1),'Position',[gonnaAttack2(1)+10,gonnaAttack2(2)+5,blood-80/65*harm2,5]);  % 骑兵初始65血
            ...
            elseif attackType==3
                ...
                fwrite(t_client,[-13,xrider2,gonnaAttack2(1),gonnaAttack2(2),harmOwn2,ordg,harm2],'double');  % 骑->弓
                harmText2;
                bloodArcher1(ordg,1)=blood-80/55*harm2;
                if bloodArcher1(ordg,1)>0  % 受攻击敌兵没有死
                    set(Drawgreen.archer(ordg,1),'Position',[gonnaAttack2(1)+10,gonnaAttack2(2)+5,blood-80/55*harm2,5]);  % 弓箭兵初始55血
            ...
            elseif attackType==4
                ...
                delete(Drawfocus2);
                delete(DrawfocusTown2);
                fwrite(t_client,[-14,harm2],'double');  % 骑->塔
                harmTextTown2;
                bloodTown1=blood-harm2;
                riderca2=1;
                if bloodTown1>0
...
%                 rider2.posStore2(xrider2,3)=1;  % 攻击后无论是否消灭敌军，都不能再移动
        ...
        elseif sum(judgebattle)>0 && battleType2==3  % 攻击者为弓箭兵
            ...
            if attackType==1
                ...
                fwrite(t_client,[-15,xarcher2,gonnaAttack2(1),gonnaAttack2(2),harmOwn2,ordg,harm2],'double');  % 弓->步
                harmText2;
                bloodRifle1(ordg,1)=blood-harm2;  % 更新受攻击敌兵的血量
                if bloodRifle1(ordg,1)>0  % 受攻击敌兵没有死
                    set(Drawgreen.rifle(ordg,1),'Position',[gonnaAttack2(1)+10,gonnaAttack2(2)+5,blood-harm2,5]);  % 步兵初始80血
            ...
            elseif attackType==2
                ...
                fwrite(t_client,[-16,xarcher2,gonnaAttack2(1),gonnaAttack2(2),harmOwn2,ordg,harm2],'double');  % 弓->骑
                harmText2;
                bloodRider1(ordg,1)=blood-80/65*harm2;
                if bloodRider1(ordg,1)>0  % 受攻击敌兵没有死
                    set(Drawgreen.rider(ordg,1),'Position',[gonnaAttack2(1)+10,gonnaAttack2(2)+5,blood-80/65*harm2,5]);  % 骑兵初始65血
            ...
            elseif attackType==3
                ...
                fwrite(t_client,[-17,xarcher2,gonnaAttack2(1),gonnaAttack2(2),harmOwn2,ordg,harm2],'double');  % 弓->弓
                harmText2;
                bloodArcher1(ordg,1)=blood-80/55*harm2;
                if bloodArcher1(ordg,1)>0  % 受攻击敌兵没有死
                    set(Drawgreen.archer(ordg,1),'Position',[gonnaAttack2(1)+10,gonnaAttack2(2)+5,blood-80/55*harm2,5]);  % 弓箭兵初始55血
            ...
            elseif attackType==4
                ...
                delete(Drawfocus2);
                delete(DrawfocusTown2);
                fwrite(t_client,[-18,harm2],'double');  % 弓->塔
                harmTextTown2;
                bloodTown1=blood-harm2;
                if bloodTown1>0
                    set(DrawredTown1,'Position',[20,803,blood-harm2,3.5]);
