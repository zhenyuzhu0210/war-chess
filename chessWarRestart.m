...
% Mainfig=figure('units','pixels','position',[350 50 bkg.Size(1,[2,1])./1.65],...
...
turn=1;
if turn==1
    set(gcf,'WindowButtonDownFcn',@clicktownb1);  % 检测鼠标点击
elseif turn==0
    set(gcf,'WindowButtonDownFcn',@clicktownb2);  % 检测鼠标点击
end
end